...
<main style="margin-bottom: 50px;" class="ui container">
    <!-- Corpo da Calculadora -->
    <div class="wrapper" id="corpo-calculadora">
        <div class="ui basic segment">
            <div style="text-align: center;">
                <h3 class="">Informe a média anual de consumo em Quilowatt-Hora <i class="circular green lightning icon"></i></h3>
            </div>
            <p></p>
            <br>
                        ...
                        <div class="ui big form">
                            <div class="inline fields">
                                <div class="two wide field">
                                    <label for="kwh">Média kWh</label>
                                </div>
                                <div class="eight wide field">
                                    <input type="number" id="kwh" pattern="[0-9]" required>
                                    <span id="find-media"><a id="modalsemantic" href="#">Encontrar média?</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div align="center">
                <div>
                    <button type="submit" class="ui big disabled primary button"><span class="txt-button">Calcular</span></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="ui container" id="corpo-resultado" style="display: none">
        <div class="ui horizontal raised segments">
            <div class="ui blue segment">
                ...
                <h4>Economia total acumulada em 30 anos</h4>
...
<div class="ui small modal">
    ...
    <div class="scrolling content">
        ...
        <div class="img-conta-energia">
            <img src="images/energia-edit.png" alt="Esta é sua conta de energia elétrica.">
        </div>
    </div>
    <div class="actions">
...
<!--<script src="http://luxenergiasolar.com.br/wp-content/themes/luxsolar/js/vendor/jquery.js"></script>-->
